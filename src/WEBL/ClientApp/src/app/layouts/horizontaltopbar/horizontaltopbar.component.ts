...
export class HorizontaltopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any, private router: Router, private eventService: EventService, private authenticationService: AuthenticationService,
  ...
  getPriceLookupBadge() {
    ...
    if (priceLookupIndex) {
      ...
      if (this.globalMethodsService.priceLookupBadgeNumber > 0) {
